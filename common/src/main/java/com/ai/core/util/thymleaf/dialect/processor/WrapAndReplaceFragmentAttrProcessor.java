 ...
 * @useage
 */
public class WrapAndReplaceFragmentAttrProcessor extends
		AbstractFragmentAttrProcessor {

	public static final int ATTR_PRECEDENCE = 103;
	public static final String ATTR_NAME = "wrap-replace";
	private final boolean removeElementWrap = true;
	private final boolean FragmentEditable = true;

	public WrapAndReplaceFragmentAttrProcessor() {
		super(ATTR_NAME);
	}
