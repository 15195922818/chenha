 ...
 * @useage
 */
public class WrapAndIncludeFragmentAttrProcessor extends
		AbstractFragmentAttrProcessor {

	public static final int ATTR_PRECEDENCE = 102;
	public static final String ATTR_NAME = "wrap-include";
	private final boolean removeElementWrap = false;
	private final boolean FragmentEditable = true;

	public WrapAndIncludeFragmentAttrProcessor() {
		super(ATTR_NAME);
	}
