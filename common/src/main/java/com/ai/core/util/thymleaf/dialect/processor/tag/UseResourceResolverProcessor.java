...
public class UseResourceResolverProcessor extends AbstractElementProcessor {

	private static Logger logger = Logger
			.getLogger(UseResourceResolverProcessor.class);
	private final static String Tag_Name = "use";
	private final static int Precedence = 100001;

	public UseResourceResolverProcessor() {
		super(Tag_Name);
	}
